...
private:
  ...
  //the number of cigars the miner has on hand. He smokes them while working in the mines.
  int				    m_iCigars;
...
public:
  ...
  bool			OutOfCigars()const;
  void			DecreaseCigars() { m_iCigars -= 1; }
  void			RestockCigars() { m_iCigars = 5; }
