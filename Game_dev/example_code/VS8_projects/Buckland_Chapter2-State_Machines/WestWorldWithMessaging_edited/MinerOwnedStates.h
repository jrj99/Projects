...
//-------------The "BuyTobbacco" Virtual functions have been added by Jared Jones (2017)

class BuyTobacco : public State<Miner>
{
private:
	...
	//copy ctor and assignment should be private
	BuyTobacco(const BuyTobacco&);
	BuyTobacco& operator=(const BuyTobacco&);
